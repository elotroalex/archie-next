...
## Review Guidelines by Submission Type

_archipelagos_ accepts submissions across several valences—critical essays, process essays, digital project dialogues, and digital project reviews. Our review process for digital projects is crafted in accordance with the [DHCommons model](http://dhcommons.org/journal/submission-guidelines), with some additions and revisions. Once peer review is completed, projects are "launched" via a dedicated page on the _archipelagos_ platform. This landing page features a brief description of and link to the project, along with excerpts of audio, visual, and other multimedia elements. This page also provides a link to (a curated version of) the dialogue between site authors and peer reviewers. We ask that digital projects submitted for review provide a minimum of two years of post-beta support, and we encourage reviewers to remain attentive to how conscious a project team is of its own life cycle. For submission requirements and review timelines specific to each valence, see the corresponding section on our [About](about.html#valences) page.

### Critical Essays

Our reviewers are expected to maintain the highest academic standards in the review of scholarly articles for publication in _archipelagos_.

Please answer the following questions with as much elaboration as you feel the author and/or editors may need.
...
4. Does the submission exhibit the kind of critical rethinking that is consistent with the _archipelagos_ project?
...
6. Does the submission exhibit the kind of critical rethinking that is consistent with the _archipelagos_ project?
...
5. Does the submission exhibit the kind of critical rethinking that is consistent with the _archipelagos_ project?
...
5. Does the project reviewed exhibit the kind of critical rethinking that is consistent with the _archipelagos_ project? We are particularly interested in reviews of projects that provide a clear sense of what is at stake in their conceptual and analytical interventions.
