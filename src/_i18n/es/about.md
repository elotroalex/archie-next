...
La base tecnológica utilizada para *archipelagos* se ofrece con una licencia MIT. Todos nuestros datos están abiertos en nuestro [repositorio de GitHub](https://github.com/elotroalex/archie-next/).
...
Por favor, familiarícese con el proceso de revisión a continuación, y consulte nuestras [pautas para evaluadores de ensayos críticos](reviewers.html#ensayos-criticos) para conocer los criterios de evaluación completos. Si tiene alguna pregunta, no dude en contactarnos en: [archipelagosjournal@gmail.com](mailto:archipelagosjournal@gmail.com).
...
Por favor, familiarícese con el proceso de revisión a continuación, y consulte nuestras [pautas para evaluadores de ensayos de proceso](reviewers.html#ensayos-de-proceso) para conocer los criterios de evaluación completos. Si tiene alguna pregunta, no dude en contactarnos en: [archipelagosjournal@gmail.com](mailto:archipelagosjournal@gmail.com).
...
Por favor, familiarícese con el proceso de revisión a continuación, y consulte nuestras [pautas para evaluadores de diálogos sobre proyectos digitales](reviewers.html#dialogos-sobre-proyectos-digitales) para conocer los criterios de evaluación completos. Si tiene alguna pregunta, no dude en contactarnos en: [archipelagosjournal@gmail.com](mailto:archipelagosjournal@gmail.com).
...
Parte de lo que hace que _archipelagos_ especial es nuestro flujo de trabajo, cuidadosamente diseñado para minimizar los costos de producción y permitir que nuestro pequeño equipo ejecute una revista académica sólida, sin servicios pagados fuera de los costos del servidor y la provisión de DOIs. Si bien cada revista tendrá requisitos y recursos únicos disponibles para el equipo, creemos que [nuestra base de software de código abierto](https://github.com/elotroalex/archie-next/) combinada con nuestro flujo de trabajo proporciona un modelo viable y portátil. El siguiente flujo de trabajo es el siguiente paso después de que la configuración original esté en su lugar.
