...
Jamaican writers in particular further diversified the Caribbean
...
<div class="epigraph">
<blockquote>some magic boy named David<br>fixed the page<br>so now<br>I might write you love notes<br>more frequent than the drip drip drip<br>of mute hellos<br>hi world<br>here we go again</blockquote>
<p class="citation">Staceyann Chin. \</p>
</div>
...
<div class="epigraph">
<blockquote>But so many of us have things that need to be said, and the Internet is the only place where those voices can be heard.</blockquote>
<p class="citation">Marlon James quoted in Laughlin, \</p>
</div>

<div class="epigraph">
<blockquote>Such is the temperament of the technological crapshoot that frames our small lives.</blockquote>
<p class="citation">Staceyann Chin. \</p>
</div>
...
The act of writing—of writing about oneself especially—implies a level
...
[^9]: Jill Walker Rettberg, "Online Diaries and Blogs," in *The Diary:
    ...
    (Bloomington: Indiana University Press, 2020), 412–13.
...
[^15]: Audre Lorde, acknowledgments to *Zami: A New Spelling of My Name*
    ...
    feminist and lesbian books. The press was short-lived (1976–83) and,
    after publishing fourteen titles, folded because of financial
    troubles. In a 1983 interview, Lorde spoke of having to pay for the
    rights to republish *Zami* and criticized Persephone for their
    treatment of women writers of color. See Karla Jay, "Speaking the
    Unspeakable: Poet Audre Lorde," in Audre Lorde, *Conversations with
    Audre Lorde*, ed. Joan Wylie Hall (Jackson: University Press of
...
[^16]: I am thinking here of Lisa Lowe's categorization of autobiography
    ...
    autobiographical genre illustrates how liberal emancipation required
    a literary narrative of the self-authoring autonomous individual to
    be distilled out of the heteronomous collective subjectivity of
    colonial slavery." Autobiography, then, raises the narrative subject
    (and therefore the writer) above the very conditions that make for
    the content and potential import of the narrative. Lisa Lowe, *The
    Intimacies of Four Continents* (Durham, NC: Duke University Press,
    2015), 2, 47.
...
[^21]: The project begins with "Part 1: Cop a Feel for All Your Sins,"
    ...
    *Revolver* was a digital publication produced by a literary arts
    ...
    <http://www.around-around.com/the-regulars/marlon-james/> for all
    thirteen pieces.

[^22]: Lowe, *Intimacies of Four Continents*, 50.

[^23]: In the *Global Voices* interview, Nicholas Laughlin asks James,
    "How is writing for your blog different to, say, writing a short
...
[^27]: I present some of these ideas about a network of bloggers in a
    ...
    forthcoming "Digital Yards: Caribbean Narrative on Social Media and
    Other Digital Platforms," in *Caribbean Literature in Transition*,
    vol. 3, *1970–2020*, ed. Ronald Cummings and Alison Donnell
    (Cambridge: Cambridge University Press, forthcoming).

[^28]: "The term supermodernity (*surmodernité*)," writes A.
    González-Ruibal, "was coined by French Anthropologist Marc Augé in
    1992 to define the period commonly known as late modernity. The
    usefulness of the concept of supermodernity, as compared to other
    definitions of the later part of modernity, rests on two things: the
    idea of exaggeration and the retention of the concept of modernity.
    Regarding the first point, Augé talks of three excesses: factual
    overabundance (which is associated with an acceleration of
    historical time), spatial overabundance (the abolishing of distance
    by electronic media and transportation), and an excess of
    self-reflexive individuality." A. González-Ruibal, "Supermodernity
    and Archaeology," in *Encyclopaedia of Global Archaeology*, ed. C.
    Smith (New York: Springer, 2014), 7125.

[^29]: See Marlon James, "Five Note Mojo," *Marlon James: Among Other
    Things…*, 11 February 2007,
    <http://marlon-james.blogspot.com/2007/02/five-note-mojo.html>; and
...
[^34]: I am thinking here of Sonya Donaldson's forthcoming essay "The
    ...
    as archival practice, in the form of "careful annotation,
    screenshotting, downloading, storage and backup." See Sonya
    Donaldson, "The Ephemeral Archive: Unstable Terrain in Times and
    Sites of Discord," in *The Digital Black Atlantic*, ed. Roopika
    Risam and Kelly Baker Josephs (Minneapolis: University of Minnesota
    Press, forthcoming).
