...
etalauthor: "Landels, Bradley, Desir, *et. al.*"
author:
- name: Tye Landels
  shortname: Landels
  bio: >
...
<div class="epigraph">
<blockquote>Where are your monuments, your battles, martyrs?<br>Where is your tribal memory? Sirs,<br>in that grey vault. The sea. The sea<br>has locked them up. The sea is History.</blockquote>
<p class="citation">Derek Walcott, \</p>
</div>
...
Recognizing this, some digital humanists have attempted to reckon with
...
While faced with the pragmatic difficulty of representing mortality in
...
room for the counterfactual possibilities and contingencies contained
...
The small boy who died on May 11, 1757 died after three weeks at sea on
...
This shift from numbers to critically fabulated narrative was, in part,
...
While, as the foregoing analysis bears out, we follow Audre Lorde in our
...
[^8]: Roopika Risam and Kelly Baker Josephs, eds., *The Digital Black
    ...
    essay in this volume, "Digital Reconnaissance: Re(Locating) Dark
    Spots on a Map," pp.108-20, Pewu writes, "Can digital maps and other
    spatial technologies provide us with new ways of conceptualizing,
    documenting, redefining, or relocating the humanity/inhumanity
    placed on, attributed to, or celebrated by Black people? As we
    discover from the works compiled in *The Digital Black Atlantic*
...
[^10]: Cf. Smallwood, who expresses her concern that "\[b\]y tallying
    the dead to measure the toll the voyage took on African life, we
    have made that body count the most potent symbolic measure of the
    horrors of the middle passage ... overall numbers---and our
    interpretation of them---correspond only loosely to the ways African
    captives experienced and understood shipboard mortality." See
    Smallwood, *Saltwater Slavery,* p. 137.

[^11]: From eighteenth-century abolitionism through to the development
    of international human rights law and the modern-day reparations
    movement, there is a long tradition of classifying slavery and slave
    trafficking as a "crime against humanity." See, e.g., Ariela Gross,
    "'A Crime Against Humanity': Slavery and The Boundaries of Legality,
    Past and Present," *Law and History Review* 35, no. 1 (2017), pp.
    1-8.

[^12]: We initially set out to combine the *Slave Voyages* and CLIWOC
    databases in order to find an overlapping subset of voyages for
    which there was both information about their exact routes and
    records of their involvement in the slave trade. Our hope was to
    find an area in the Atlantic where a great number of deaths had
    occurred. Andrew Sluyter has done a similar project with twenty-six
    Dutch slaving voyages, but we hoped to produce results on a larger
    scale. In order to make sense of this large archive, we
    cross-referenced ships' names and dates of departure in the *Slave
    Voyages Database* with CLIWOC to produce a map of nine
    journeys. Mapping these journeys revealed that many of the ships in
    CLIWOC were not slaving vessels and that the names of these ships
    were often reused.

[^13]: Johnson, "Markup Bodies."

[^14]: Brown writes, "Gains that derive from elucidating general trends
    are offset by insensitivity to the experience of the historical
    subject. Considerations of scale, variation, and typicality trade
    the anguish and confusion of dimly discernible experiences for
    perceived mastery of the facts." See Vincent Brown, *Reaper's
...
[^17]: Cf. Hartman's recognition that "redressing the violence that
    produced numbers, ciphers, and fragments of discourse, which is as
    close as we come to a biography of the captive and the enslaved" is
    an "impossible goal." See Hartman, "Venus in Two Acts," p. 3.

[^18]: According to Matthew Wilson, critical cartography proceeds from
    the assumption "\[t\]hat maps stratify and create the potentialities
    for resistance." See Matthew W. Wilson, *New Lines: Critical GIS and
    the Trouble of the Map* (Minneapolis: University of Minnesota Press,
    2017), p. 7.

[^19]: Catherine D\'Ignazio and Lauren F. Klein. *Data Feminism*
    (Cambridge, MA: MIT Press, 2020), p. 73.

[^20]: Following Njelle Hamilton, we understand "re-membering" as
    signifying "the connections between remembrance---the repeated
    psychological reassembling of memories---and re-membering---the
    physical reassembling of the disarticulated or shattered members of
    the ... body." See Njelle W. Hamilton, *Phonographic Memories:
    Popular Music and the Contemporary Caribbean Novel* (New Brunswick,
    NJ: Rutgers University Press, 2019), p. 80. Likewise, we acknowledge
    and share Katherine McKittrick's concerns around scholarly obsession
    with Black bodies: "\[c\]an the preoccupation with the black
    body---whether that involves liberating it from scientific racism or
    honoring it as a site of resistance---perhaps conceal a range of
    black knowledge formations that, while certainly embodied, are not
    reduced to the biologic?" See Katherine McKittrick, *Dear Science
    and Other Stories* (Durham, NC: Duke University Press, 2021), p. 49.

[^21]: For instance, in one of the team's first research trips, team
    member Jane Harwell found that the logbook of the slave ship
    *Marlborough* (c. 1750) contained neither observations about
    location nor about mortality.
...
[^23]: In the logbook of the *Good Hope*, latitudinal and longitudinal
    coordinates are given in the format of degrees minutes seconds
    (DMS), with the small issue that seconds are not listed, but the
    crucial information of degrees and minutes is captured. This made
    determining the actual position of the *Good Hope* at any given
    point of time uncertain but not impossible. For example, one of the
    entries on Saturday, 30 April 1757, had the boat at 9 28 N, 16 1 W
    or 9 Degrees 28 Minutes North 16 Degrees 1 Minute West. In order to
    map these coordinates using modern mapping software, we needed to
    convert the DMS coordinates into decimal degrees. For the purposes
    of our project, we estimated seconds as zero.

[^24]: It is worth reflecting on how these changing methods of mapping
    the ocean and measuring movement across it inflect our understanding
    of those who, like the small boy, disappeared below its surface. In
    *The Social Construction of the Ocean*, Philip Steinberg notes that,
    "\[b\]y the early seventeenth century, maps featuring sea monsters
    representing marine nature and ships representing the social
    activity that transpired in the area of ocean-space began to be
    replaced by maps portraying a grid over an essentially featureless
    ocean." This focus on the surface as the "known" aspect of the ocean
    had the effect of rendering the oceanic depths the complementary
    "unknown." By ejecting the bodies of the enslaved from the realm of
    the known and the measurable, enslavers may have hoped to erase them
    entirely. On the contrary, as Katherine McKittrick and Clyde Woods
    argue, "\[t\]he storm-torn bodies, those thrown overboard and
    forgotten, and the many other narratives and experiences that are
    violently and/or uncomfortably situated with the geography of reason
    have produced what Edouard Glissant calls submarine roots: a network
    of branches, cultures, and relations that position black geographies
    and the oceanic history of diaspora as integral to and entwining
...
[^42]: Rediker, *The Slave Ship: A Human History* (London: John Murray,
    2007), p. 41; and Smallwood, *Saltwater Slavery*, p. 5.
