...
abstract_fr: >
  La Base de données historique du Suriname et des Caraïbes (HDSC) est un réseau d'historiens et d'archivistes des Caraïbes néerlandaises, du Suriname et des Pays-Bas qui collaborent afin de créer des bases de données en libre accès sur la population du Suriname et des Caraïbes (néerlandaises) entre 1830 et 1950, destinées à un usage public et scientifique. Les registres d'esclaves (années 1830-1863) et le registre d'état civil de la population libre (années 1830-1950) des anciennes colonies néerlandaises des Caraïbes constituent l'épine dorsale du projet, car ils permettent aux chercheurs et au public de reconstituer des parcours de vie. Cet article présente le projet et invite le lecteur à collaborer à un projet transcaribéen. Il décrit les possibilités d'un pipeline interopérable pour les bases de données historiques sur la population des Caraïbes, en mettant l'accent sur le processus de construction et de mise en relation des données. Depuis 2017, la HDSC a développé plusieurs flux de travail numériques qui peuvent servir de modèle à des efforts similaires de reconstitution de populations historiques. L'un des principes fondamentaux du projet est l'engagement de rendre l'ensemble des données et des flux de travail accessibles en libre accès à tous les chercheurs. Le partage des flux de travail développés et la discussion des défis et des obstacles qui entravent la réussite du projet constituent les bases de cet objectif à long terme. Bien que le projet se concentre actuellement sur les effets du colonialisme, de l'esclavage et du travail sous contrat dans l'empire néerlandais des Caraïbes, le HDSC espère collaborer avec d'autres chercheurs pour relier toutes les données disponibles aux territoires non néerlandais et créer une base de données interconnectée sur les populations et les schémas migratoires pour l'ensemble de la région des Caraïbes.
abstract_es: >
  La Base de Datos Histórica de Surinam y el Caribe (la HDSC o Historical Database of Suriname and the Caribbean) es una red de historiadores y archiveros en el Caribe holandés, Surinam y los Países Bajos. Este colectivo trabaja para crear bases de datos de acceso libre sobre la población de Surinam y el Caribe (holandés) entre 1830 y 1950, tanto para uso público como académico. Los llamados registros de esclavos (décadas de 1830 a 1863) y el registro civil de la población libre (décadas de 1830 a 1950) de las antiguas colonias holandesas en el Caribe constituyen la columna vertebral del proyecto, ya que, permiten tanto a académicos como al público general reconstruir el curso de vida de personas esclavizadas. Este artículo discute el proyecto e invita al lector a colaborar en una iniciativa de investigación trans-caribeña. Además, se delinean las posibilidades de crear procesos interoperables para las bases de datos históricas de la población del Caribe enfatizando la construcción y vinculación de datos. Desde 2017, la HDSC ha desarrollado múltiples flujos de trabajo digitales que pueden funcionar como un plan para impulsar iniciativas similares que reconstruyen poblaciones históricas. Entre sus valores principales se encuentra el compromiso al acceso libre a los datos y estrategias laborales (workflows) con cualquier investigador interesado. Compartir estas estrategias así como discutir los retos y factores que dificultan su éxito contribuye al cumplimiento de esta meta a largo plazo. Aunque el proyecto actualmente se enfoca en los efectos del colonialismo, la esclavitud y los trabajos forzosos impuestos por el imperio holandés en el Caribe, la HDSC se propone colaborar con investigadores en un futuro para conectar todos los datos disponibles con territorios no-holandeses y crear una base de datos interconectada de personas y patrones de migración para toda la región del Caribe.
language: en
pdf: true
---
